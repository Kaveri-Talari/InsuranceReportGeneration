package com.insurance.insurance.Runner;
...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        c1.setCitizenName("Kaveri");
        c1.setGender("Female");
        c1.setPlanName("Cash");
        c1.setPlanStatus("Approved");
        c1.setPlanStartDate(LocalDate.now());
        c1.setPlanEndDate(LocalDate.now().plusMonths(6));
        c1.setBenefitAmount(3000.00);


        CitizenPlan c2=new CitizenPlan();
        c2.setCitizenName("Nazriya");
        c2.setGender("Female");
        c2.setPlanName("Cash");
        ...
        List<CitizenPlan> citizenPlanList=Arrays.asList(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12);

        citizenPlanRepo.saveAll(citizenPlanList);
